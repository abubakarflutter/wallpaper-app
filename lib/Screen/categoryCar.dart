...
class CategoryCar extends StatefulWidget {
  const CategoryCar({Key? key}) : super(key: key);

  @override
  State<CategoryCar> createState() => _CategoryCarState();
}

class _CategoryCarState extends State<CategoryCar> {
  late Future<List<CategoryPageModel>> CatCarFuture;
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    CatCarFuture = SendRequestCategoryPhoto();
  ...
  Future<List<CategoryPageModel>> SendRequestCategoryPhoto() async {
    ...
    print(respons);
    for (var item in respons.data["CategoryCar"]) {
